...
def update_branch_supplier(): 
    ...
    bookTable = "branch_supplier" # Book Table
    ...
    headingLabel = Label(headingFrame1, text="Update Branch Supplier", bg='black', fg='white', font=('Courier',15))
    ...
    # Book ID
    lb1 = Label(labelFrame,text="Branch id : ", bg='black', fg='white')
    ...
    # Title
    lb2 = Label(labelFrame,text="Supplier name : ", bg='black', fg='white')
    ...
    # Book Author
    lb3 = Label(labelFrame,text="Supply Type : ", bg='black', fg='white')
