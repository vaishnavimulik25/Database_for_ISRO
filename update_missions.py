...
def update_missions(): 
    ...
    headingLabel = Label(headingFrame1, text="Update Mission", bg='black', fg='white', font=('Courier',15))
    ...
    # Book ID
    lb1 = Label(labelFrame,text="Mission Name : ", bg='black', fg='white')
    ...
    # Title
    lb2 = Label(labelFrame,text="Employee id: ", bg='black', fg='white')
    ...
    # Book Author
    lb3 = Label(labelFrame,text="Client id : ", bg='black', fg='white')
    ...
    # Book Status
    lb4 = Label(labelFrame,text="Revenue : ", bg='black', fg='white')
