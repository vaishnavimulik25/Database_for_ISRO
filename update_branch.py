...
def update_branch(): 
    ...
    headingLabel = Label(headingFrame1, text="Update Branch", bg='black', fg='white', font=('Courier',15))
    ...
    # Title
    lb2 = Label(labelFrame,text="Branch Name: ", bg='black', fg='white')
    ...
    # Book Author
    lb3 = Label(labelFrame,text="Manager id: ", bg='black', fg='white')
    ...
    # Book Status
    lb4 = Label(labelFrame,text="Manager start date : ", bg='black', fg='white')
